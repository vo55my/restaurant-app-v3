...
/* harmony export */ });
/* harmony import */ var _views_pages_favorites__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(210);
...
var routes = {
  ...
  '/favorites': _views_pages_favorites__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z,
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _data_RestaurantSource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(746);
        ...
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            submit.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
              var review, reviewContainer, response;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.prev = 3;
                    _context.next = 6;
                    return _data_RestaurantSource__WEBPACK_IMPORTED_MODULE_0__/* ["default"].addReview */ .Z.addReview(review);
                  case 6:
                    response = _context.sent;
                    _data_RestaurantSource__WEBPACK_IMPORTED_MODULE_0__/* ["default"].getDetailRestaurant */ .Z.getDetailRestaurant(url.id);
                    reviewContainer.innerHTML = (0,_views_templates_template_creator__WEBPACK_IMPORTED_MODULE_1__/* .createReviewTemplate */ .ZE)(response.customerReviews);
                    _context.next = 14;
                    break;
                  case 11:
                    _context.prev = 11;
                    _context.t0 = _context["catch"](3);
                    reviewContainer.innerHTML = "<p>".concat(_context.t0.message, "</p>");
                  case 14:
                    _this._resetForm();
                  case 15:
                  case "end":
...
var LikeButtonPresenter = {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return _this2._favoriteRestaurants.getRestaurant(id);
          case 2:
            resto = _context2.sent;
            return _context2.abrupt("return", !!resto);
          case 4:
          case "end":
            return _context2.stop();
        }
  ...
  _renderButton: function _renderButton() {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            id = _this3._restaurant.id;
            _context3.next = 3;
            return _this3._isMovieExist(id);
          case 3:
            if (!_context3.sent) {
              _context3.next = 7;
              break;
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return _this4._favoriteRestaurants.getRestaurant(id);
          case 2:
  ...
  _renderLike: function _renderLike() {
    var _this5 = this;
    this._likeButtonContainer.innerHTML = (0,_views_templates_template_creator__WEBPACK_IMPORTED_MODULE_0__/* .createLikeButtonTemplate */ .ty)();
    ...
    likeButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return _this5._favoriteRestaurants.putRestaurant(_this5._restaurant);
          case 2:
  ...
  _renderLiked: function _renderLiked() {
    var _this6 = this;
    this._likeButtonContainer.innerHTML = (0,_views_templates_template_creator__WEBPACK_IMPORTED_MODULE_0__/* .createLikedButtonTemplate */ .ci)();
    var likeButton = document.querySelector('#likeButton');
    likeButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return _this6._favoriteRestaurants.deleteRestaurant(_this6._restaurant.id);
          case 2:
            _this6._renderButton();
          case 3:
          case "end":
